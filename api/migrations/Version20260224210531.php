 ...
 */
final class Version20260224210531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE movies (id UUID NOT NULL, tmdb_id INT DEFAULT NULL, radarr_id INT DEFAULT NULL, title VARCHAR(500) NOT NULL, original_title VARCHAR(500) DEFAULT NULL, year INT DEFAULT NULL, synopsis TEXT DEFAULT NULL, poster_url VARCHAR(1000) DEFAULT NULL, backdrop_url VARCHAR(1000) DEFAULT NULL, genres VARCHAR(500) DEFAULT NULL, rating NUMERIC(3, 1) DEFAULT NULL, runtime_minutes INT DEFAULT NULL, radarr_monitored BOOLEAN DEFAULT NULL, radarr_has_file BOOLEAN DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, radarr_instance_id UUID DEFAULT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE scheduled_deletions (id UUID NOT NULL, scheduled_date DATE NOT NULL, execution_time TIME(0) WITHOUT TIME ZONE NOT NULL, status VARCHAR(20) NOT NULL, delete_physical_files BOOLEAN NOT NULL, delete_radarr_reference BOOLEAN NOT NULL, delete_media_player_reference BOOLEAN NOT NULL, reminder_days_before INT DEFAULT NULL, reminder_sent_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, executed_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, execution_report JSON DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, created_by_id UUID NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE volumes (id UUID NOT NULL, name VARCHAR(255) NOT NULL, path VARCHAR(500) NOT NULL, host_path VARCHAR(500) NOT NULL, type VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL, total_space_bytes INT DEFAULT NULL, used_space_bytes INT DEFAULT NULL, last_scan_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, updated_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY (id))');
