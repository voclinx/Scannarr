...
class ScheduledDeletion
{
    ...
    public function setScheduledDate(\DateTimeInterface $scheduledDate): static { $this->scheduledDate = $scheduledDate; return $this; }
    public function getExecutionTime(): \DateTimeInterface { return $this->executionTime; }
    public function setExecutionTime(\DateTimeInterface $executionTime): static { $this->executionTime = $executionTime; return $this; }
    public function getStatus(): DeletionStatus { return $this->status; }
    public function setStatus(DeletionStatus $status): static { $this->status = $status; return $this; }
    public function isDeletePhysicalFiles(): bool { return $this->deletePhysicalFiles; }
    public function setDeletePhysicalFiles(bool $deletePhysicalFiles): static { $this->deletePhysicalFiles = $deletePhysicalFiles; return $this; }
    public function isDeleteRadarrReference(): bool { return $this->deleteRadarrReference; }
    public function setDeleteRadarrReference(bool $deleteRadarrReference): static { $this->deleteRadarrReference = $deleteRadarrReference; return $this; }
    public function isDeleteMediaPlayerReference(): bool { return $this->deleteMediaPlayerReference; }
    public function setDeleteMediaPlayerReference(bool $deleteMediaPlayerReference): static { $this->deleteMediaPlayerReference = $deleteMediaPlayerReference; return $this; }
    public function getReminderDaysBefore(): ?int { return $this->reminderDaysBefore; }
    public function setReminderDaysBefore(?int $reminderDaysBefore): static { $this->reminderDaysBefore = $reminderDaysBefore; return $this; }
    ...
    public function setExecutedAt(?\DateTimeImmutable $executedAt): static { $this->executedAt = $executedAt; return $this; }
